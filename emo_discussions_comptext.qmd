...
2.  Different effects of emotions are overlooked
        ...
        -   ignoring the origin of emotions.
:::
:::
:::
...
::: notes
Here, we can see the regression coefficients testing the effect of the treatment on the emotions in the discussoin

-   There are significant differences in most emotions, except for enthusiasm, however, we observe substantially more anger, more out-group references and less joy in response to untrustworthy information
:::
...
-   The results of our model show that a lower trustworthiness score is associated with more retweets and quote retweets
:::
